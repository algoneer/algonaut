...
class ModelResult(Base):
    ...
    model = relationship('Model', backref=backref('results', cascade="all,delete,delete-orphan"))
    result = relationship('Result', backref=backref('models', cascade="all,delete,delete-orphan"))
