...
class AlgorithmVersion(Base):
    ...
    algorithm_id = Column(PkType, ForeignKey('algorithm.id'), index=True, nullable=False)
    algorithm = relationship('Algorithm', backref=backref('versions', cascade="all,delete,delete-orphan"))
