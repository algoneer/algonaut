...
class DataSetVersionResult(Base):
    ...
    datasetversion = relationship('DataSetVersion', backref=backref('results', cascade="all,delete,delete-orphan"))
    result = relationship('Result', backref=backref('datasets', cascade="all,delete,delete-orphan"))
